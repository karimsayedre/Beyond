...
namespace rtxgi
{
    namespace vulkan
    {
        ...
        public:
            ...
            ERTXGIStatus Create(VkCommandBuffer cmdBuffer, bool updateShaders, const DDGIVolumeDesc& desc, const DDGIVolumeResources& resources);
        #else
			...
			// Shader Modules
			void SetProbeBlendingIrradianceModule(VkShaderModule module) { m_probeBlendingIrradianceModule = module; }
			void SetProbeBlendingDistanceModule(VkShaderModule module) { m_probeBlendingDistanceModule = module; }
			void SetProbeRelocationModule(VkShaderModule module) { m_probeRelocationModule = module; }
			void SetProbeRelocationResetModule(VkShaderModule module) { m_probeRelocationResetModule = module; }
			void SetProbeClassificationModule(VkShaderModule module) { m_probeClassificationModule = module; }
			void SetProbeClassificationResetModule(VkShaderModule module) { m_probeClassificationResetModule = module; }
			void SetProbeVariabilityReductionModule(VkShaderModule module) { m_probeVariabilityReductionModule = module; }
			void SetProbeVariabilityExtraReductionModule(VkShaderModule module) { m_probeVariabilityExtraReductionModule = module; }
        ...
        #if RTXGI_DDGI_RESOURCE_MANAGEMENT
            ERTXGIStatus CreateManagedResources(const DDGIVolumeDesc& desc, const DDGIVolumeManagedResourcesDesc& managed, bool updateShaders);
