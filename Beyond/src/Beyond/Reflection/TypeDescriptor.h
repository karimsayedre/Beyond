...
struct Beyond::Type::Description<Class, Tag> : Beyond::Type::MemberList<__VA_ARGS__>, Beyond::Type::DescriptionInterface<Beyond::Type::Description<Class,Tag>, Class, Tag, Beyond::Type::MemberList<__VA_ARGS__>>	\
{																		\
private:																\
...
public:																	\
	...
	static constexpr std::array<std::string_view, NumberOfMembers> MemberNames										\
		= Beyond::Utils::RemoveNamespace<NumberOfMembers>(																	\
			Beyond::Utils::SplitString<NumberOfMembers>(MemberStr, Delimiter));												\
};
#endif // !DESCRIBED


#ifndef DESCRIBED
#define DESCRIBED(Class, ...) DESCRIBED_TAGGED(Class, Beyond::Type::TDummyTag, __VA_ARGS__)
#endif
