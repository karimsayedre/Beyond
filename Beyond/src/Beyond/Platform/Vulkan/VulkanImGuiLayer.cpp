...
namespace Beyond {
	...
	VulkanImGuiLayer::VulkanImGuiLayer(const eastl::string& name)
	{
	...
	void VulkanImGuiLayer::OnAttach()
	{
		...
		// Configure Fonts
		{
			...
			static const ImWchar s_FontAwesomeRanges[] = { BEY_ICON_MIN, BEY_ICON_MAX, 0 };
		...
		Renderer::Submit([instance]()
		{
			...
			VKUtils::SetDebugUtilsObjectName(device, VK_OBJECT_TYPE_DESCRIPTOR_POOL, "ImGui Descriptor Pool", descriptorPool);
			...
			// Upload Fonts
			{
				...
				VkCommandBuffer commandBuffer = vulkanContext->GetCurrentDevice()->CreateCommandBuffer("ImGui uploading fonts", true);
	...
	bool VulkanImGuiLayer::OnImGuiRender()
	{
		return false;
	}
