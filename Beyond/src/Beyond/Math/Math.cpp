...
namespace Beyond::Math {
	...
	bool DecomposeTransform(const glm::mat4& transform, glm::vec3& translation, glm::quat& rotation, glm::vec3& scale)
	{
		...
		BEY_CORE_ASSERT(epsilonEqual(LocalMatrix[3][3], static_cast<T>(1), static_cast<T>(0.00001)));
		...
		BEY_CORE_ASSERT(dot(Row[0], Pdum3) >= static_cast<T>(0));
#endif
