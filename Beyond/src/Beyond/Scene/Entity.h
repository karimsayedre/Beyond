...
namespace Beyond {
	...
	public:
		...
		const eastl::string& Name() const { return HasComponent<TagComponent>() ? GetComponent<TagComponent>().Tag.c_str() : EANoName; }
	...
	private:
		...
		inline static eastl::string EANoName = "Unnamed";
