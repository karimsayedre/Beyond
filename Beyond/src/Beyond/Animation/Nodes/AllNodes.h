...
// 5) register the new node type in the node registry for runtime (Beyond::AnimationGraph::Registry, in Animation/AnimationGraphFactory.cpp)
// 6) register the new node type in the node registry for editor (Beyond::NodeGraph::Factory<Beyond::AnimationGraph::AnimationGraphNodeFactory>::Registry, in Editor/NodeGraphEditor/AnimationGraph/AnimationGraphNodes.cpp)
