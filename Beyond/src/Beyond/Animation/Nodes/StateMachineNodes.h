...
DESCRIBE_NODE(Beyond::AnimationGraph::StateMachine,
	NODE_INPUTS(),
	NODE_OUTPUTS(
		&Beyond::AnimationGraph::StateMachine::out_Pose)
);

DESCRIBE_NODE(Beyond::AnimationGraph::State,
	NODE_INPUTS(),
	NODE_OUTPUTS(
		&Beyond::AnimationGraph::State::out_Pose)
);

DESCRIBE_NODE(Beyond::AnimationGraph::QuickState,
	NODE_INPUTS(
		&Beyond::AnimationGraph::QuickState::in_Animation),
	NODE_OUTPUTS(
		&Beyond::AnimationGraph::QuickState::out_Pose)
);

DESCRIBE_NODE(Beyond::AnimationGraph::TransitionNode,
	NODE_INPUTS(),
	NODE_OUTPUTS()
);
