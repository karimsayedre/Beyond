...
namespace Beyond::AnimationGraph {
	...
	struct NodeProcessor
	{
		...
		inline static choc::value::Type PoseType = [] {
			choc::value::Type type = choc::value::Type::createArray(TransformType, Beyond::Animation::MAXBONES + 1); // RootMotion, BoneTransforms
		...
		//            This will then cause graph validation to fail, or worse, crash Beyond with a null ptr deference.
