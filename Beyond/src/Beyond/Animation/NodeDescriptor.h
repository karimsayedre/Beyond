...
#define DESCRIBE_NODE(NodeType, InputList, OutputList)                                         \
	DESCRIBED_TAGGED(NodeType, Beyond::AnimationGraph::TagInputs, InputList)                    \
	DESCRIBED_TAGGED(NodeType, Beyond::AnimationGraph::TagOutputs, OutputList)                  \
	                                                                                           \
	template<> struct Beyond::AnimationGraph::NodeDescription<NodeType>                         \
	{                                                                                          \
		using Inputs = Beyond::Type::Description<NodeType, Beyond::AnimationGraph::TagInputs>;   \
		using Outputs = Beyond::Type::Description<NodeType, Beyond::AnimationGraph::TagOutputs>; \
	};
#endif // !DESCRIBE_NODE
