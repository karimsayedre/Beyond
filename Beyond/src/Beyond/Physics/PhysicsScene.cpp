...
namespace Beyond {
	...
	const Ref<Scene>& PhysicsScene::GetEntityScene() const
	{
		return m_EntityScene;
	}

	Ref<Scene> PhysicsScene::GetEntityScene()
	{
		return m_EntityScene;
	}
	...
	{
		BEY_PROFILE_SCOPE_DYNAMIC("PhysicsSystem::SubStepStrategy");
	...
	{
		BEY_PROFILE_FUNC("PhysicsScene::PreSimulate");
	...
	{
		BEY_PROFILE_FUNC("PhysicsScene::PostSimulate");
