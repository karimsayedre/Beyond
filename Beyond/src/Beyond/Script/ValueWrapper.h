...
namespace Beyond::Utils {
	...
	public:
		...
		{
			BEY_CORE_VERIFY(HasValue(), "ValueWrapper::Get - No value!");
		...
		{
			BEY_CORE_VERIFY(HasValue(), "Trying to set the value of an empty ValueWrapper!");
			...
			{
				BEY_CORE_VERIFY(m_Size == sizeof(value));
