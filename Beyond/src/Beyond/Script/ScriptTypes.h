...
namespace std {
	...
	template<>
	struct hash<Beyond::AssemblyMetadata>
	{
		size_t operator()(const Beyond::AssemblyMetadata& metadata) const
		{
			size_t result = 0;
			Beyond::Utils::HashCombine(result, metadata.Name);
			Beyond::Utils::HashCombine(result, metadata.MajorVersion);
			Beyond::Utils::HashCombine(result, metadata.MinorVersion);
			Beyond::Utils::HashCombine(result, metadata.BuildVersion);
			Beyond::Utils::HashCombine(result, metadata.RevisionVersion);
			return result;
		}
	};
