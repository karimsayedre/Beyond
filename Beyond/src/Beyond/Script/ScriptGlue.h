...
#pragma region PointLightComponent
		...
		void PointLightComponent_SetCastsShodows(uint64_t entityID, bool castsShadows);
		bool PointLightComponent_GetCastsShadow(uint64_t entityID);
		void PointLightComponent_SetSoftShodows(uint64_t entityID, bool softShadows);
