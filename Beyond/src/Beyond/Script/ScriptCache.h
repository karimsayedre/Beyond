...
#define BEY_CORE_CLASS(clazz) ScriptCache::GetManagedClassByName("Beyond."#clazz)
#define BEY_CACHED_CLASS(clazz) ScriptCache::GetManagedClassByName(clazz)
#define BEY_CACHED_CLASS_RAW(clazz) ScriptCache::GetManagedClassByName(clazz)->Class
#define BEY_CACHED_METHOD(clazz, method, paramCount) ScriptCache::GetSpecificManagedMethod(ScriptCache::GetManagedClassByName(clazz), method, paramCount)
#define BEY_CACHED_FIELD(clazz, field) ScriptCache::GetFieldByName(ScriptCache::GetManagedClassByName(clazz), field)
#define BEY_CACHED_FIELD_STORAGE(clazz, field) ScriptCache::GetFieldStorage(ScriptCache::GetFieldByName(ScriptCache::GetManagedClassByName(clazz), field)->ID)
//#define BEY_TRY_GET_FIELD_VALUE(ret, className, fieldName, storageObj){\
...
//																		}\
//																	 }
#define BEY_SCRIPT_CLASS_ID(name) Hash::GenerateFNVHash(name)
