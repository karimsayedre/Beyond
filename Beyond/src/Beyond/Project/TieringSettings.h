	...
	namespace Tiering {
		...
		namespace Renderer {
			...
			namespace Utils {
				...
				inline ShadowQualitySetting ShadowQualitySettingFromString(eastl::string_view shadowQualitySetting)
				{
				...
				inline ShadowResolutionSetting ShadowResolutionSettingFromString(eastl::string_view shadowResolutionSetting)
				{
				...
				inline AmbientOcclusionQualitySetting AmbientOcclusionQualitySettingFromString(eastl::string_view ambientOcclusionQualitySetting)
				{
					if (ambientOcclusionQualitySetting == "None")   return AmbientOcclusionQualitySetting::None;
					if (ambientOcclusionQualitySetting == "Low")    return AmbientOcclusionQualitySetting::High; // NOTE: low has been renamed to high, currently there is no low
				...
				inline SSRQualitySetting SSRQualitySettingFromString(eastl::string_view ssrQualitySetting)
				{
