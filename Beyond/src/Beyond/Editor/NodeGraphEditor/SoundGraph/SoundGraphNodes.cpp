...
namespace Alias = Beyond::SoundGraph::NameAliases;
...
namespace Colors = Beyond::SoundGraph::Colors;

template<>
const Beyond::Nodes::Registry Beyond::Nodes::Factory<SG::SoundGraphNodeFactory>::Registry =
{
	NODE_CATEGORY(Base,
...
template<>
const Beyond::Nodes::EnumTokensRegistry Beyond::Nodes::Factory<SG::SoundGraphNodeFactory>::EnumTokensRegistry =
{
