...
#include "Beyond/Audio/SoundGraph/Nodes/NodeDescriptors.h"
...
namespace Beyond::SoundGraph {
	...
	public:
		...
		[[nodiscard]] Beyond::Node* SpawnNode(const std::string& category, const std::string& type) const override { return SpawnNodeStatic(category, type); }
		...
		static constexpr Node* CreateNodeForProcessorOld()
		{
			...
			auto* node = new SGTypes::SGNode(0, Beyond::Utils::SplitAtUpperCase(TDescriptor::ClassName.data()), ImColor(255, 128, 128));
		...
		[[nodiscard]] static Node* CreateNodeForProcessor()
		{
			...
			auto* newNode = new SGTypes::SGNode(Beyond::Utils::SplitAtUpperCase(TDescriptor::Inputs::ClassName.data()), ImColor(255, 128, 128));
...
using TTestNode = NodeDescription<Beyond::SoundGraph::Add<float>>;
...
static const StaticAction sa([] { PrivateMap::Add("Beyond::SoundGraph::Add<float>::in_Value1", SGTypes::Audio); });

#define NODE_OVERRIDES(NodeType, Overrides, ...)\
static const StaticAction sa([] { PrivateMap::Add("Beyond::SoundGraph::Add<float>::in_Value1", SGTypes::Audio); });\


NODE_OVERRIDES(Beyond::SoundGraph::Add<float>,
	{ Beyond::SoundGraph::Add<float>::in_Value1, SGTypes::TPin<SGTypes::Audio> }
);
#endif
