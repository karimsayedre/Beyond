...
#include "Beyond/Animation/Nodes/AllNodes.h"
#include "Beyond/Utilities/StringUtils.h"

#include <array>

namespace Alias = Beyond::AnimationGraph::Alias;
...
#undef DECLARE_DEF_VALUE
	...
	std::optional<choc::value::Value> GetPinDefaultValueOverride(std::string_view nodeName, std::string_view memberNameSanitized)
	{
		...
		BEY_CORE_ASSERT(nodeName.find("::") == std::string_view::npos);
		BEY_CORE_ASSERT(memberNameSanitized.find("::") == std::string_view::npos);
	...
	{
		BEY_CORE_ASSERT(graph);
		BEY_CORE_ASSERT(((type != EPropertyType::LocalVariable) ^ isLocalVarGetter.has_value()), "'isLocalVarGetter' property must be set if 'type' is 'LocalVariable'");
		...
		{
			BEY_CORE_ERROR("SpawnGraphPropertyNode() - property with the name \"{}\" doesn't exist!", propertyName);
			return nullptr;
		}
		...
		//{
		//	BEY_CORE_ERROR("SpawnGraphPropertyNode() - invalid Graph Property value to spawn Graph Property node. Property name {}", propertyName);
		//	return nullptr;
		//}
...
template<>
const Beyond::Nodes::Registry Beyond::Nodes::Factory<AG::AnimationGraphNodeFactory>::Registry =
{
...
template<>
const Beyond::Nodes::Registry Beyond::Nodes::Factory<AG::StateMachineNodeFactory>::Registry =
{
...
template<>
const Beyond::Nodes::Registry Beyond::Nodes::Factory<AG::TransitionGraphNodeFactory>::Registry =
{
	NODE_CATEGORY(Array,
		DECLARE_NODE_N(AG::Get<float>,                                         Colors::Float,          NodeType::Blueprint),
		DECLARE_NODE_N(AG::Get<int>,                                           Colors::Int,            NodeType::Blueprint),
...
template<>
const Beyond::Nodes::Registry Beyond::Nodes::Factory<AG::BlendSpaceNodeFactory>::Registry =
{
...
#define DECLARE_PIN_ENUM(MemberPointer, Tokens) { std::string(Beyond::Nodes::SanitizeMemberName(#MemberPointer, true)),  Tokens }

template<>
const Beyond::Nodes::EnumTokensRegistry Beyond::Nodes::Factory<AG::AnimationGraphNodeFactory>::EnumTokensRegistry =
{
};

template<>
const Beyond::Nodes::EnumTokensRegistry Beyond::Nodes::Factory<AG::StateMachineNodeFactory>::EnumTokensRegistry =
{
};

template<>
const Beyond::Nodes::EnumTokensRegistry Beyond::Nodes::Factory<AG::TransitionGraphNodeFactory>::EnumTokensRegistry =
{
};

template<>
const Beyond::Nodes::EnumTokensRegistry Beyond::Nodes::Factory<AG::BlendSpaceNodeFactory>::EnumTokensRegistry =
{
};
