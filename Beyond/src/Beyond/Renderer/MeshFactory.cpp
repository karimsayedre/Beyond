...
namespace Beyond {
	...
	AssetHandle MeshFactory::CreateBox(const glm::vec3& size)
	{
		...
		AssetHandle meshSourceHandle = AssetManager::CreateMemoryOnlyAsset<MeshSource>(vertices, indices, glm::mat4(1.0f), "MeshFactory Box");
		Ref<MeshSource> meshSource = AssetManager::GetAsset<MeshSource>(meshSourceHandle);
		return AssetManager::CreateMemoryOnlyAsset<StaticMesh>(meshSource, "MeshFactory Box");
	}
	...
	AssetHandle MeshFactory::CreateSphere(float radius)
	{
		...
		AssetHandle meshSourceHandle = AssetManager::CreateMemoryOnlyAsset<MeshSource>(vertices, indices, glm::mat4(1.0f), "MeshFactory Sphere");
		Ref<MeshSource> meshSource = AssetManager::GetAsset<MeshSource>(meshSourceHandle);
		return AssetManager::CreateMemoryOnlyAsset<StaticMesh>(meshSource, "MeshFactory Sphere");
	}
	...
	AssetHandle MeshFactory::CreateCapsule(float radius, float height)
	{
		...
		AssetHandle meshSourceHandle = AssetManager::CreateMemoryOnlyAsset<MeshSource>(vertices, indices, glm::mat4(1.0f), "MeshFactory Capsule");
		Ref<MeshSource> meshSource = AssetManager::GetAsset<MeshSource>(meshSourceHandle);
		return AssetManager::CreateMemoryOnlyAsset<StaticMesh>(meshSource, "MeshFactory Capsule");
	}
}
