...
#include "Beyond/Renderer/RendererConfig.h"
...
namespace Beyond {
	...
	public:
		...
		{
			return std::exchange(s_HasChanged, false);
		}
	...
	private:
		inline static bool s_HasChanged;
