...
namespace Beyond
{
	internal static class InternalCalls
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		public static extern void AnimationComponent_GetInputVector3(ulong entityID, uint inputID, out Vector3 result);
		[MethodImpl(MethodImplOptions.InternalCall)]
		public static extern void AnimationComponent_SetInputVector3(ulong entityID, uint inputID, ref Vector3 value);
		[MethodImpl(MethodImplOptions.InternalCall)]
		public static extern void AnimationComponent_SetInputTrigger(ulong entityID, uint inputID);
		[MethodImpl(MethodImplOptions.InternalCall)]
