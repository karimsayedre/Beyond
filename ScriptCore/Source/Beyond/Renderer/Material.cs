...
namespace Beyond
{
	public sealed class Material : IEquatable<Material>
	{
		public override int GetHashCode()
		{
			unchecked
			{
				var hashCode = m_MeshHandle.GetHashCode();
				hashCode = (hashCode * 397) ^ m_Handle.GetHashCode();
				hashCode = (hashCode * 397) ^ (m_MeshComponent != null ? m_MeshComponent.GetHashCode() : 0);
				return hashCode;
			}
		}
