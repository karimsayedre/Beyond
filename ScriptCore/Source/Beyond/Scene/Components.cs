...
namespace Beyond
{
	...
	public class AnimationComponent : Component
	{
		...
		{
			InternalCalls.AnimationComponent_GetInputVector3(Entity.ID, inputID, out Vector3 result);
			return result;
		}

		public void SetInputVector3(uint inputID, Vector3 value)
		{
			InternalCalls.AnimationComponent_SetInputVector3(Entity.ID, inputID, ref value);
		}
