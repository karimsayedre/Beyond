...
Payload TraceRay(RayDesc ray, uint bounceIndex)
{
    ...
    TraceRay(TLAS,
             ...
             RAY_FLAG_SKIP_PROCEDURAL_PRIMITIVES, 0xFF, 0, 0, 0, ray, packedPayload);
#endif
...
[shader("anyhit")]
void main(inout RayPackedPayload packedPayload, BuiltInTriangleIntersectionAttributes attrib)
{
    uint2 launchIndex = DispatchRaysIndex().xy;
    uint2 launchDimensions = DispatchRaysDimensions().xy;
