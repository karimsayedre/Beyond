 ...
 */
DDGIPackedPayload PackPayload(DDGIPayload input)
{
    DDGIPackedPayload output = (DDGIPackedPayload)0;
 ...
 */
DDGIPayload UnpackPayload(DDGIPackedPayload input)
{
    DDGIPayload output = (DDGIPayload)0;
    output.hitT = input.hitT;
    output.worldPosition = input.worldPosition;
...
{
    float2 delta1 = vertices[1].TexCoord - vertices[0].TexCoord;
    float2 delta2 = vertices[2].TexCoord - vertices[0].TexCoord;
