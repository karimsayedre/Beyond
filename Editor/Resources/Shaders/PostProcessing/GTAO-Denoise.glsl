...
{
	return ((uint(clamp(unpackedInput.x, 0.0, 1.0) * 255.f + 0.5f)) | (uint(clamp(unpackedInput.y, 0.0, 1.0) * 255.f + 0.5f) << 8) | (uint(clamp(unpackedInput.z, 0.0, 1.0) * 255.f + 0.5f) << 16) |
...
void main()
{
	...
	AOTermType visQ0[4];
	XeGTAO_DecodeGatherPartial(textureGatherOffset(u_AOTerm, gatherCenter, ivec2(0, 0)), visQ0);
	AOTermType visQ1[4];
	XeGTAO_DecodeGatherPartial(textureGatherOffset(u_AOTerm, gatherCenter, ivec2(2, 0)), visQ1);
	AOTermType visQ2[4];
	XeGTAO_DecodeGatherPartial(textureGatherOffset(u_AOTerm, gatherCenter, ivec2(0, 2)), visQ2);
	AOTermType visQ3[4];
	XeGTAO_DecodeGatherPartial(textureGatherOffset(u_AOTerm, gatherCenter, ivec2(2, 2)), visQ3);
