...
[[vk::combinedImageSampler]] [[vk::binding(3, 2)]] Texture2D<lpfloat> u_HiZDepth;
[[vk::combinedImageSampler]] [[vk::binding(3, 2)]] SamplerState u_samplerPointClamp;
...
#define XE_GTAO_DEPTH_MIP_LEVELS                    0                   // this one is hard-coded to 5 for now
...
void XeGTAO_MainPass(const int2 outputPixCoord, const int2 inputPixCoords, lpfloat sliceCount, lpfloat stepsPerSlice, const lpfloat2 localNoise)
{
    ...
    lpfloat3 viewspaceNormal = viewspaceNormalLuminance.xyz * 2.0 - 1.0;
    ...
    // see "Algorithm 1" in https://www.activision.com/cdn/research/Practical_Real_Time_Strategies_for_Accurate_Indirect_Occlusion_NEW%20VERSION_COLOR.pdf
    {
        ...
        for (lpfloat slice = 0; slice < sliceCount; slice++)
        {
            ...
            for (lpfloat step = 0; step < stepsPerSlice; step++)
            {
                ...
                const lpfloat mipLevel = (lpfloat)clamp(log2(sampleOffsetLength) - XE_GTAO_DEFAULT_DEPTH_MIP_SAMPLING_OFFSET, 0, XE_GTAO_DEPTH_MIP_LEVELS);
        ...
        visibility = (lpfloat)pow(visibility, (lpfloat)XE_GTAO_DEFAULT_FINAL_VALUE_POWER * lerp(1.0f, (lpfloat)u_GTAOConsts.ShadowTolerance, viewspaceNormalLuminance.a));
