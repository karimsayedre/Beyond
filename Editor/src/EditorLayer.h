...
#include "Beyond/Editor/ECSDebugPanel.h"

#include "Beyond/Editor/PanelManager.h"

#include "Beyond/Project/UserPreferences.h"
...
namespace Beyond {
	...
	public:
		...
		void NewScene(const eastl::string& name = "UntitledScene");
		bool OpenScene();
	...
	private:
		...
		void UpdateWindowTitle(const eastl::string& sceneName);
