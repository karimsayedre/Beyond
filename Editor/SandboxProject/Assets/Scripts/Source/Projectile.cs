        ...
        protected override void OnUpdate(float ts)
        {
            ...
            if (m_Destroy)
            {
                for (int i = 0; i < 10; i++)
                {
                    ...
                    Vector3 dir = new Vector3(Beyond.Random.Float() * 2.0f - 1.0f, Beyond.Random.Float() * 2.0f - 1.0f + 1.0f, Beyond.Random.Float() * 2.0f - 1.0f);
                    Vector3 force = dir * Beyond.Random.Float() * 50.0f;
