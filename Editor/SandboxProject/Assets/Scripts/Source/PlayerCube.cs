...
namespace Example
{
    class PlayerCube : Entity
    {
        ...
        protected override void OnCreate()
        {
            ...
            {
                float x = CubeSpawnOffset.X + Beyond.Random.Float() * CubeSpawnRange.X;
                float y = CubeSpawnOffset.Y + Beyond.Random.Float() * CubeSpawnRange.Y;
                CreateCube(new Vector2(x, y), Beyond.Random.Float() * 10.0f, i);
            }
        }
